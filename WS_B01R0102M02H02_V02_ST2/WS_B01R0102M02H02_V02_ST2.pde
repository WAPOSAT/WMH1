...
#define point1_cal 11069
// Point 2 of the calibration 
#define point2_cal 1090

// Sensor de pH
// Calibration values
#define cal_point_10 2.049
#define cal_point_7 2.112
#define cal_point_4 2.180
// Temperature at which calibration was carried out
#define cal_temp 16.7
...
void loop(){
  ...
  snprintf(url,sizeof(url), "http://monitoreo.waposat.com/monitor/abc|123|20|%s|19|%s|22|%s|23|%s|24|%s",float_str_temp, float_str_ph, float_str_cond, float_str_battery,float_str_do);
  snprintf(urlsd,sizeof(urlsd), "http://monitoreo.waposat.com/monitor/abc|123|1|%02u%02u%02u%02u%02u%02u|20|%s|19|%s|22|%s|23|%s|24|%s",RTC.year,RTC.month,RTC.date,RTC.hour, RTC.minute, RTC.second,float_str_temp, float_str_ph, float_str_cond, float_str_battery, float_str_do);
