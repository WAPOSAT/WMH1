...
// USB.println(float_str_ph);
  ...
  USB.println(value_cond_calculated); 
    ...
    snprintf(url,sizeof(url), "http://monitoreo.waposat.com/monitor/abc|123|20|%s|19|%s|22|%s|23|%s",float_str_temp, float_str_ph, float_str_cond, float_str_battery, float_str_do);
