...
*/
  ...
  snprintf(urlsd,sizeof(urlsd), "http://monitoreo.waposat.com/monitor/abc|123|1|%s|2|%s|3|%s|4|%s|5|%s|6|%s año:%02u mes:%02u dia:%02u hora:%02u minuto:%02u segundo:%02u  ",float_str_ph,float_str_temp, float_str_do, float_str_orp, float_str_cond, float_str_battery,RTC.year,RTC.month,RTC.date,RTC.hour, RTC.minute, RTC.second);
...
//    sprintf(filename,"%02u%02u%02u%02u.TXT",RTC.date,RTC.hour, RTC.minute, RTC.second);
    //sprintf(url," datos fecha %02u%02u%02u%02u",RTC.date,RTC.hour, RTC.minute, RTC.second);
    //USB.print(url
    // char hola[50]="hola";
