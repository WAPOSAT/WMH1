...
//  USB.println(value_orp_calculated);
 ...
 RTC.getTime();
  ...
  snprintf(urlsd,sizeof(urlsd), "http://monitoreo.waposat.com/monitor/abc|123|1|%02u%02u%02u%02u%02u%02u|10|%s|18|%s|5|%s|21|%s",RTC.year,RTC.month,RTC.date,RTC.hour, RTC.minute, RTC.second,float_str_temp, float_str_ph, float_str_cond, float_str_battery);
